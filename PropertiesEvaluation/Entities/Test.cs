...
namespace GOLite.Entities
{
    ...
    "\tДля исключения ошибок рекомендуется вычеркивать или обводить кружком номер качества, оценка которого произведена.\r\n" +
     ...
     "\tВыраженность качеств оценивается по цифровой шкале, в которой максимальной выраженности ЛЕВОГО качества соответствует оценка \"1\", а максимальной выраженности ПРАВОГО -оценка \"7\".\r\n" +
     "\tСредняя оценка \"4\" означает: \"ни одно, ни другое\"; \"оба в равной мере\"; \"проявляется то одно, то другое\"; \"не знаю\"; \"не могу оценить\"; \"не уверен\".\r\n" +
     "\tС остальными оценками можно связать следующие формулировки:\r\n" +
            "\t3, 5 - качество немного заметно, проявляется редко;\r\n" +
            "\t2, 6 - качество заметно, проявляется достаточно часто;\r\n" +
            "\t1, 7 - качество ярко выражено, проявляется всегда.\r\n" +
